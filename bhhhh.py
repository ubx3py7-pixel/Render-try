#!/usr/bin/env python3
"""
bhhhh.py — Manager + Worker (split deliver: Part 1)
...
# Build manager app (this must come after manager handlers)
def build_manager_app(token: str) -> Application:
    ...
    return app
  # ---------------------------
# Worker: raid texts, helpers, builder
# Paste Part 2 after Part 1
# ---------------------------
RAID_TEXTS = [
...
async def start_all():
    ...
    # ensure manager token is not placeholder
    global manager_app
